...
* Multi-platforma: Corre en Linux(probado en Ubuntu 14.04 y 16.06) y Windows (probado en Windows 7 y 10)
...
Se cuenta con un [manual disponible](https://github.com/clbustos/buhos/tree/master/docs/manual), que contiene una guía rápida para entender la metodología de revisión sistemática que sustena el software.
